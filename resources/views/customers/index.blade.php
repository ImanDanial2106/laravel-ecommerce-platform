                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3">Address</th> <!-- ADDED THIS HEADER -->
                            ...
                            <tbody>
                                @forelse ($customers as $customer)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $customer->name }}</th>
                                        <td class="px-6 py-4">{{ $customer->email }}</td>
                                        <td class="px-6 py-4">{{ $customer->phone }}</td>
                                        <td class_=""="px-6 py-4 max-w-xs truncate">{{ $customer->address }}</td> <!-- ADDED THIS DATA -->
                                        <td class="px-6 py-4 text-right flex items-center justify-end space-x-4">
                                            <a href="{{ route('customers.edit', $customer->id) }}" class="font-medium text-indigo-600 dark:text-indigo-500 hover:underline">Edit</a>
                                ...
                                @empty
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        <td colspan="5" class="px-6 py-4 text-center">No customers found.</td> <!-- Updated colspan to 5 -->
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
